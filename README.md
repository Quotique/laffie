...
Система встраивает интерпретатор Python (через `pyo3`) для делегирования части
преобразований в sympy. На macOS это требует разовой настройки путей к Python —
см. [Настройка Python на macOS](doc/ru/macos_python_setup.md).
